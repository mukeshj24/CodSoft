...
def submit_record():
    global name_var, email_var, phone_var, address_entry
    global cursor
    name, email, phone, address = name_var.get(), email_var.get(), phone_var.get(), address_entry.get(1.0, END)
...
def view_record():
    global name_var, phone_var, email_var, address_entry, listbox
...
lf_bg = 'light blue'  # Lightest Shade
cf_bg = 'light blue'
rf_bg = 'light yellow'  # Darkest Shade
...
Label(root, text='CONTACT BOOK', font=("Roboto", 20, "bold"), bg='light green', fg='red').pack(side=TOP, fill=X)
...
listbox = Listbox(right_frame, selectbackground='SkyBlue', bg='Gainsboro', font=('Roboto', 12), height=20, width=25)
