...
# Label to display the winner each time
...
rock_btn = Button(input_frame, text='Rock', width=15, bd=0, bg='lightcoral', pady=5, command=lambda: player_choice(choices[0]))
rock_btn.grid(row=1, column=1, padx=8, pady=5)

paper_btn = Button(input_frame, text='Paper', width=15, bd=0, bg='lightcyan', pady=5, command=lambda: player_choice(choices[1]))
paper_btn.grid(row=1, column=2, padx=8, pady=5)

scissors_btn = Button(input_frame, text='Scissors', width=15, bd=0, bg='lightsalmon', pady=5, command=lambda: player_choice(choices[2]))
...
player_choice_label = Label(input_frame, text='Your Selection: ---', font=app_font)
player_choice_label.grid(row=3, column=1, pady=5)

player_score_label = Label(input_frame, text='Your Score: -', font=app_font)
player_score_label.grid(row=3, column=2, pady=5)

computer_choice_label = Label(input_frame, text='Computer Selection: ---', font=app_font, fg='black')
